  ...
  return (
    <div className="max-w-4xl mx-auto p-5 mt-10">
      ...
      <main>
        ...
        <section className="bg-[#f9fafb] p-6 rounded-sm shadow-md mb-6">
          ...
          <p className="select-none mt-2 clear-both">
            ...
            Services.
            <br />
            We do not offer refunds or exchanges once a product has been purchased.
            However, if the product is damaged upon arrival, you may contact us
            via Instagram or email to register a complaint. To qualify for a refund,
            you must record a video while opening the package to demonstrate
            that the product was defective upon receipt. Once we verify your claim,
      ...
      <footer className="text-center text-gray-600 text-sm p-5 mt-10">
        ...
        <a
          href="https://www.instagram.com/lady.ish_/"
